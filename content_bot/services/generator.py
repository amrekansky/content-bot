...
Длина: 150-300 слов. Только абзацы, без буллетов и списков.
Канал без комментариев — читатели могут только поставить реакцию. Не проси писать комментарии.
Заканчивается одним коротким CTA: либо призыв переслать пост, либо риторический вопрос, либо мысль на которой стоит остановиться — без призыва что-то написать.
