...
- Карусели (TikTok и Instagram со слайдами-инфографиками) — это изображения, не аудио.
  yt-dlp скачивает видео, но слайды — это отдельные картинки внутри поста.
  Нужен отдельный механизм: скачать картинки → OCR каждой → собрать текст.
  Это следующий этап.
